# app.py - Versión corregida con subpath
...
CORS(app, supports_credentials=True, resources={
    r"/chatbotia/*": {
        "origins": ["http://intranetqa.bas.com.ar", "http://localhost:*", "http://127.0.0.1:*"]
    }
})
...
# Rutas para archivos estáticos con subpath
...
# Rutas de administración con subpath
